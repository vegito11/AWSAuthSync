...
import (
	...
	v1beta "github.com/vegito11/AWSAuthSync/pkg/client/informers/internalversion/v1beta"
...
func (f *sharedInformerFactory) V1beta() v1beta.Interface {
	return v1beta.New(f, f.namespace, f.tweakListOptions)
}
